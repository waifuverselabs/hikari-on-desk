...
const SCHEMA = {
  ...
  // Ambient desktop-activity mode (hikari only): the pet reacts to your own
  // desktop activity — typing, an open document, audio playing — when no agent
  // session is active. See src/ambient-activity.js.
  ambientActivity: { type: "boolean", default: true },
  shortcuts: {
    type: "object",
  ...
  // Theme
  theme: { type: "string", default: "hikari" },
