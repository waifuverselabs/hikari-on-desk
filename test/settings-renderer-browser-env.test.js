...
describe("settings renderer browser environment", () => {
  ...
  it("groups Theme cards and exposes theme import actions in Settings", () => {
    ...
    assert.strictEqual(strings.en.themeImportUserThemeZip, "Import Hikari theme package (.zip)");
    ...
    assert.strictEqual(strings.zh.themeImportUserThemeZip, "导入 Hikari 主题包（.zip）");
